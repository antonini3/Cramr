...
- (void)jsq_configureTextView
{
    ...
    self.backgroundColor = [UIColor colorWithRed:51.0/255.0 green:82.0/255.0 blue:178.0/255.0 alpha:0.6];
    self.layer.borderWidth = 0.5f;
    self.layer.borderColor = [UIColor jsq_messageBubbleLightGrayColor].CGColor;
    ...
    _placeHolder = nil;
    _placeHolderTextColor = [UIColor jsq_messageBubbleLightGrayColor];
